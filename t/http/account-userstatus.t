...
Test {
  ...
  return $current->create (
    ...
    return $current->are_errors (
      ...
      [
        {params => {account_id => undef, user_status => 6},
         status => 400, name => 'No |account_id|'},
        {params => {account_id => 'abd', user_status => 6},
         status => 400, name => 'Bad |account_id|'},
        {params => {account_id => 12515333, user_status => 6},
         status => 400, name => 'Not found |account_id|'},
        {params => {user_status => 6, sk_context => rand, sk => rand},
         status => 400, name => 'Bad session'},
        {params => {user_status => 6}, session => 's3',
         status => 400, name => 'Bad session'},
        {params => {
          account_id => $current->o ('a2')->{account_id},
          user_status => 0,
